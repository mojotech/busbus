...
{
    NSString *requestString = [NSString stringWithFormat:@"http://localhost:8888/api/near-stops?latitude=%f&longitude=%f&distance=800",coordinate.latitude, coordinate.longitude];
